...
class ModeFinder(object):
    ...
    @staticmethod
    def _model_likelihood(x: torch.Tensor, y: torch.Tensor, old_x: torch.Tensor, parameters, state: TimeseriesState, model: StateSpaceModel) -> torch.Tensor:
    ...
    def find_mode_legacy(self, x_dist: Distribution, initial_state: TimeseriesState, std: torch.Tensor, y: torch.Tensor) -> Distribution:
        """
